...
";
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          $img = strtolower(str_replace(' ', '_', $nama)) . ".jpg"; // contoh: American Steak -> american_steak.jpg
          echo "
        ...
        echo "<p class='text-center text-white'>Tidak ada produk di kategori ini.</p>";
      }
    } else {
      echo "<p class='text-center text-white'>Kategori tidak ditemukan.</p>";
    }
  ?>
</div>
